...
/*      */         //   0	7	0	this	Lde/Jakob/navine/util/Renderer$R3D$FadingBlock; } public final int hashCode() { // Byte code:
/*      */         //   0: aload_0
...
/*  408 */         //   0	8	1	o	Ljava/lang/Object; } public Color outline() { return this.outline; } public Color fill() { return this.fill; } public class_243 start() { return this.start; } public class_243 dimensions() { return this.dimensions; } public long created() { return this.created; } public long lifeTime() { return this.lifeTime; }
/*      */        long getLifeTimeLeft() {
/*  410 */         return Math.max(0L, this.created - System.currentTimeMillis() + this.lifeTime);
/*      */       }
/*      */       
/*      */       boolean isDead() {
/*  414 */         return (getLifeTimeLeft() == 0L); } } static interface RenderAction { void run(class_287 param2class_287, float param2Float1, float param2Float2, float param2Float3, float param2Float4, float param2Float5, float param2Float6, float param2Float7, float param2Float8, float param2Float9, float param2Float10, Matrix4f param2Matrix4f); } } class null extends R3D.Renderable { null(class_243 pos) { super(pos); } void draw() { Renderer.R3D.useBuffer(class_293.class_5596.field_27380, class_290.field_1576, class_757::method_34540, bufferBuilder1 -> { double r; for (r = 0.0D; r < 360.0D; r += 360.0D / segments1) { double rad1 = Math.toRadians(r); double sin = Math.sin(rad1); double cos = Math.cos(rad1); double offX = sin * rad; double offY = cos * rad; bufferBuilder1.method_22918(matrix, (float)offX, 0.0F, (float)offY).method_22915(col[0], col[1], col[2], col[3]).method_1344(); bufferBuilder1.method_22918(matrix, (float)(offX + sin * width), 0.0F, (float)(offY + cos * width)).method_22915(col[0], col[1], col[2], col[3]).method_1344(); }  }); } } class null extends R3D.Renderable { null(class_243 pos) { super(pos); } void draw() { Renderer.R3D.genericAABBRender(class_293.class_5596.field_29344, class_290.field_1576, class_757::method_34540, m, start, dimensions, color, (buffer, x1, y1, z1, x2, y2, z2, red, green, blue, alpha, matrix) -> { buffer.method_22918(matrix, x1, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(red, green, blue, alpha).method_1344(); }); } } class null extends R3D.Renderable { null(class_243 pos) { super(pos); } void draw() { Renderer.R3D.useBuffer(class_293.class_5596.field_27382, class_290.field_1576, class_757::method_34540, buffer -> { buffer.method_22918(matrix, x1, y2, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(redFill, greenFill, blueFill, alphaFill).method_1344(); }); Renderer.R3D.useBuffer(class_293.class_5596.field_29344, class_290.field_1576, class_757::method_34540, buffer -> { buffer.method_22918(matrix, x1, y1, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(redOutline, greenOutline, blueOutline, alphaOutline).method_1344(); }); } } class null extends R3D.Renderable { null(class_243 pos) { super(pos); } void draw() { Renderer.R3D.genericAABBRender(class_293.class_5596.field_27382, class_290.field_1576, class_757::method_34540, s, start, dimensions, color, (buffer, x1, y1, z1, x2, y2, z2, red, green, blue, alpha, matrix) -> { buffer.method_22918(matrix, x1, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y2, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z1).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x2, y1, z2).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z2).method_22915(red, green, blue, alpha).method_1344(); }); } } class null extends R3D.Renderable { null(class_243 pos) { super(pos); } void draw() { Renderer.R3D.genericAABBRender(class_293.class_5596.field_29344, class_290.field_1576, class_757::method_34540, s, start, end.method_1020(start), color, (buffer, x, y, z, x1, y1, z1, red, green, blue, alpha, matrix) -> { buffer.method_22918(matrix, x, y, z).method_22915(red, green, blue, alpha).method_1344(); buffer.method_22918(matrix, x1, y1, z1).method_22915(red, green, blue, alpha).method_1344(); }); } } static abstract class Renderable { class_243 pos; public Renderable(class_243 pos) { this.pos = pos; } abstract void draw(); public class_243 getPos() { return this.pos; } } static final class FadingBlock extends Record { private final Color outline; private final Color fill; private final class_243 start; private final class_243 dimensions; boolean isDead() { return (getLifeTimeLeft() == 0L); }
/*      */     private final long created;
/*      */     private final long lifeTime;
/*      */     FadingBlock(Color outline, Color fill, class_243 start, class_243 dimensions, long created, long lifeTime) { this.outline = outline;
/*      */       this.fill = fill;
/*      */       this.start = start;
...
/*      */       // Local variable table:
/*      */       //   start	length	slot	name	descriptor
/*      */       //   0	7	0	this	Lde/Jakob/navine/util/Renderer$R3D$FadingBlock; }
...
/*      */       //   start	length	slot	name	descriptor
/*      */       //   0	8	0	this	Lde/Jakob/navine/util/Renderer$R3D$FadingBlock;
/*      */       //   0	8	1	o	Ljava/lang/Object; } public Color outline() { return this.outline; } public Color fill() { return this.fill; } public class_243 start() { return this.start; } public class_243 dimensions() { return this.dimensions; } public long created() {
/*      */       return this.created;
...
/* Location:              /Users/iangoss/Downloads/navine-3.2.8.jar!/de/Jakob/navine/util/Renderer.class
